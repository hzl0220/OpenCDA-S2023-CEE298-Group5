...
class Controller:
    ...
    def dynamic_pid(self):
        ...
        # kp_lat, kd_lat, ki_lat = ...
            PID_factor = 1.2
            kp_lon, kd_lon, ki_lon = kp_lon_base * PID_factor, kd_lon_base * PID_factor, ki_lon_base * PID_factor
            kp_lat, kd_lat, ki_lat = kp_lat_base * PID_factor, kd_lat_base * PID_factor, ki_lat_base * PID_factor
