...
def clustering(point_cloud: o3d.geometry.PointCloud,
    ...
    # clusters = ...
    # points = np.asarray(point_cloud.points)
    clusters = np.array(point_cloud.cluster_dbscan(eps=1, min_points=min_cluster_size))
    # END TODO
...
def compute_3d_bounding_boxes(cluster_labels, point_cloud):
    ...
    # Log
    print("bbx amount: ", len(bounding_boxes))
...
if __name__ == '__main__':
    pcd = o3d.io.read_point_cloud('/home/group5/OpenCDA/opencda/customize/core/sensing/perception/debug.pcd')
